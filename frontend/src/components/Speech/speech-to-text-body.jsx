...
function Body() {
  return (
    <div className="flex flex-col w-full min-h-screen p-6 gap-10 items-start bg-base-200">
      <BodyHeader />
      ...
      {/* <div className="flex flex-row items-center justify-between w-full h-auto p-0 bg-transparent">
        <div className="flex flex-col items-start justify-start w-auto h-auto p-0 gap-0 bg-transparent">
          <div className="flex flex-col items-start justify-start w-full h-auto p-0 gap-0 bg-transparent">
            <span className=" font-bold text-[36px] leading-[44px] tracking-[-0.72px] text-base-content inline-block h-auto w-auto">
              Audio Intelligence
            </span>
          </div>
          <div className="flex flex-col items-start justify-start w-full h-auto p-0 gap-0 bg-transparent">
            <span className=" font-normal text-[16px] leading-[24px] tracking-normal text-base-content/70 inline-block w-auto h-auto">
        ...
        <div className="flex flex-row items-center justify-start w-auto h-[56px] px-6 py-4 gap-[8px] bg-black rounded-lg shadow-md">
          <button className=" font-normal text-[16px] leading-[24px] tracking-normal text-neutral-content text-center w-fit h-fit">
            ၊၊||၊ Upload New Audio
          </button>
        </div>
      </div> */}
      ...
      {/* <div className="grid grid-cols-2 gap-6 w-full h-auto p-0">
        //topleft
        <div className="flex flex-col items-start gap-1 p-4 w-full h-fit bg-base-100 border border-base-200 rounded-xl">
          <div className="flex flex-row items-center gap-2 w-full h-fit p-0">
            <span className=" font-bold text-[12px] leading-[16px] tracking-[0.6px] text-base-content/70 w-fit h-fit">
              💵 Extracted Budget
            </span>
          </div>
          <div className="flex flex-col items-start gap-0 pt-0 pb-3 px-0 w-full h-fit">
            <span className=" font-bold text-[20px] leading-[16px] tracking-[0.6px] text-base-content">
              Return Budget Value
            </span>
          </div>
          <div className="flex flex-col items-start gap-0 p-0 w-full h-fit">
            <span className=" font-italic text-[12px] leading-[16px] tracking-[0.6px] text-base-content">
              Flexible limit mentioned
            </span>
          </div>
        </div>
        //top right
        <div className="flex flex-col items-end gap-1 p-4 w-full h-fit bg-base-100 border border-base-200 rounded-xl">
          <div className="flex flex-row items-center gap-2 w-full h-fit p-0">
            <span className=" font-bold text-[12px] leading-[16px] tracking-[0.6px] text-base-content/70 w-fit h-fit">
              🏠Preferences
            </span>
        ...
        //bottom
        <div className="col-span-2 flex flex-col items-start gap-4 p-4 w-full h-fit bg-base-100 border border-base-200 rounded-xl">
          <div className="flex flex-row items-center gap-2 w-full h-fit p-0">
            <span className=" font-bold text-[12px] leading-[16px] tracking-[0.6px] text-base-content/70 w-fit h-fit">
              ❗ High Urgency Signal
            </span>
          ...
          <div className="flex flex-row items-center gap-2 w-full h-fit p-0">
            <div className="flex flex-col items-start gap-0 py-1 px-4 w-fit h-[26px] bg-info/20 rounded-full">
              <span className=" font-bold text-[12px] leading-[16px] tracking-[0.6px] text-base-content/70 w-fit h-fit">
                Return Signal 1
              </span>
            </div>
        ...
        <div className="col-span-12 flex flex-col items-start gap-6 p-6 w-full h-fit bg-base-100 border border-base-200 rounded-xl">
          <div className="flex flex-col items-start gap-2 p-0 w-full h-fit">
            <div className="flex flex-row items-center gap-0 pt-0 pb-0 pl-2 pr-0 w-full h-fit">
              <button className="w-[100px] h-[100px] flex items-center justify-center rounded-full bg-blue-600 text-neutral-content font-semibold text-sm shadow-sm hover:bg-blue-700 transition-colors">
                D
              </button>
              <div className="flex flex-col items-start gap-3 p-2 w-full h-fit">
                <div className="flex flex-col items-start  p-4 w-full h-fit bg-base-100 mb-1">
                  <span className=" font-bold text-[24px] leading-[16px] tracking-[0.6px] text-base-content/70 w-fit h-fit">
                    Return Customer name{" "}
                  </span>
                </div>
                <div className="flex flex-col items-start p-4 w-full h-fit bg-whiite">
                  <span className=" font-regular text-[12px] leading-[16px] tracking-[0.6px] text-base-content/70 w-fit h-fit">
                ...
                <div className="flex flex-row items-start justify-start gap-2 w-fit h-fit bg-[#000000] text-[#FFFFFF] rounded-lg">
                  <button className="flex flex-col items-center justify-center pl-4 pr-[11.5px] pt-4 pb-[12.5px] w-fit h-fit rounded-lg bg-[#000000]  text-[13px] font-bold leading-[18px] text-[#FFFFFF] rounded-lg">
                    Add to Pipeline
                  </button>
                </div>
              </div>
              //audioplaybackcard
              <div className="flex flex-col items-start justify-center p-4 w-[926.33px] h-[72px] gap-0 rounded-lg bg-base-200">
                  ...
                  <div className="flex flex-col items-start justify-center gap-1 w-full max-w-[796.33px] h-[26px]">
                    ...
                    <div className="flex flex-row justify-between items-start w-full h-fit p-0 bg-transparent">
                      <div className="flex flex-col justify-start items-start w-fit h-full gap-0 p-0 bg-transparent">
                        <span class="font-mono font-medium text-[12px] leading-[16px] tracking-normal text-left text-base-content/70 w-fit h-fit">
                          12:00
                        </span>
                      </div>
                      <div className="flex flex-col justify-start items-start w-fit h-full gap-0 p-0 bg-transparent">
