function AudioPlaybackCard() {
  return (
    <div className="flex flex-col justify-center p-4 w-full rounded-lg bg-base-200">
      <div className="flex flex-row items-center gap-4 w-full h-10">
        ...
        <div className="flex flex-col justify-center gap-1 w-full">
          ...
          <div className="flex justify-between w-full">
            <span className="font-mono text-xs text-base-content/60">12:00</span>
            <span className="font-mono text-xs text-base-content/60">24:00</span>
          </div>
        </div>
